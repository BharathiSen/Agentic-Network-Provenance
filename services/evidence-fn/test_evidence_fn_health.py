"""Scaffold check for the evidence-fn service (builds, signs, and submits records).
...
def test_evidence_fn_scaffold_is_ready():
    assert True


def test_evidence_fn_shares_the_provenance_information_model():
